...
//   // @ts-ignore
//   checkFields<Omit<CartProps, "isOpen" | "onClose"> & PageProps>({
//     ...otherProps,
//     isOpen, // Make sure to include 'isOpen'
//   });
...
//               height={500}
//             ></Image>
//             <span className="text-2xl font-extrabold cursiv text-orange-500 ">
//               {" "}
//               Empty your Cart
//             </span>
//           </p>
...
//               className="hover:border hover:bg-[#DB4444] items-center justify-center p-4 rounded-md "
//             >
//               <p>{item.name}</p>
...
// // Dummy checkFields function for illustration
// function checkFields<T>(props: T) {
//   console.log("Checking fields:", props);
// }
