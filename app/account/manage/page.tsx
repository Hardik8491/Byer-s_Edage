        ...
        <div className="w-[80%] flex flex-col bg-white">
          <div className="flex items-center gap-2 justify-between px-4 pb-10  ">
            <div className="flex items-center gap-2 ">
              <span className=" p-3 rounded-full border-r-red-700 border-t border-b border-red-300 border-r-8 ">
                {" "}
                <img
                  src="/eshop.jpg"
                  width={90}
              ...
              <h1 className="text-3xl text-red-400  font-semibold px-4">
                Buyers Edge{" "}
              </h1>
            </div>
          ...
          <div className="flex">
            ...
            <div className="w-[30%] mt-6 h-full text-gray-400 ">
              <div className="grid grid-cols-1 h-[50%] gap-6 ">
                ...
                <div className="bg-red-50 px-5  rounded-xl hover:bg-red-400 hover:text-white flex items-center gap-6">
                  <div className="ico  text-red-400  hover:text-white group-hover:text-white  ">
                    <BiUser />
                  </div>
                ...
                <div className="bg-red-50 px-5  rounded-xl hover:bg-red-400 hover:text-white flex items-center gap-6">
                  <div className="ico  text-red-400  hover:text-white group-hover:text-white  ">
                    <ImAttachment className="ico text-red-700" />
                  </div>
            ...
            <div className="w-[100%] flex flex-col mt-2  ">
              <div className="mb-10">
                <h2 className="flex  font-sans  flex-col text-4xl tracking-widest font-semibold  p-4 ">
                  DashBoard
                </h2>
              ...
              <div>
                <div className="contaienr grid grid-cols-4 gap-4 p-4">
                  <div className="bg-blue-50  w-full flex flex-col px-10 py-1 rounded-2xl ">
                  ...
                  <div className="bg-green-50 w-full px-10 py-1  flex flex-col   rounded-2xl">
                    <p className="py-2">CPU</p>
                    <span className="py-10">
                      Your need a hardwere for computer
                    </span>
                  ...
                  <div className="bg-red-50 w-full px-10 py-1  flex flex-col   rounded-2xl">
                    <p className="py-2">CPU</p>
                    <span className="py-10">
                      Your need a hardwere for computer
                    </span>
                  ...
                  <div className="bg-gray-50 w-full px-10 py-1  flex flex-col    rounded-2xl">
                    <p className="py-2">CPU</p>
                    <span className="py-10">
                      Your need a hardwere for computer
                    </span>
              ...
              <div className="grid grid-cols-2 gap-4 mt-6 ">
                ...
                <div className=" flex flex-col p-4 ">
                  ...
                  <div className="grid grid-cols-1 gap-2 p-4">
                    <div className=" flex w-20  items-center gap-2 justify-between">
                      <img
                        src="/p4.png"
                        alt="img"
                        width={80}
                      ...
                      <button className="py-1 px-4 = text-orange-600 bg-gray-50 rounded-xl">
                        Details
                      </button>
                    </div>
                    <div className=" flex w-20  items-center gap-2 justify-between">
                ...
                <div className="flex flex-col p-4">
                  ...
                  <div className="bg-gray-100 rounded-xl mt-10 flex flex-col item gap-2">
                    ...
                    <p className="text-slate-800 items-center p-4">
                      ...
                      Velit corrupti cupiditate quidem.
                    </p>
        ...
        <div className="p-6  h-full  rounded-3xl shadow-md bg-slate-50 w-[25%]">
          ...
          <div className="relative  w-full ">
            <span
              ...
              className=" p-1 right-0 absolute  active:text-bold bg-gray-50 "
            >
              <BiLogOut />
            </span>
          ...
          <div className="grid grid-cols-2 mt-6 p-4 items-center w-full gap-4  list-none rounded-xl shadow-sm bg-white  ">
            ...
            <li className="flex flex-col p-1  items-center ">
              <span
                className="py-1 px-1 bg-violet-50 font-medium text-red-500 flex items-center rounded-xl
              w-full"
              >
          ...
          <div className="grid grid-cols-1 mt-6 p-4 items-center w-full gap-4  list-none rounded-xl shadow-sm bg-white  ">
            <div className="flex flex-col  ">
              ...
              <div className="w-full bg-[#ede5f659] h-[7px] my-3 py-3  flex items-center rounded-md">
                <div
                  className="bg-orange-600 h-[18px] rounded-md flex items-center justify-center  relative "
                  style={{ width: "32%" }}
                >
                  <span className="text-white bg-orange-600 absolute  font-Poppins font-medium h-[18px]  flex items-center justify-center rounded-md px-[.9375rem] top-0 mt-[-0px] right-0 translate-x-2/4">
