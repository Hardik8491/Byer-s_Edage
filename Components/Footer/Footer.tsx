...
const Footer = () => {
  return <div className="bg-black">
    <div className=" sm:px-[10px] md:px-[20px] lg:px-[60px] xl:px-[80px]"
    // className="px-4 md:px-8 lg:px-16 xl:px-30 xl:mx-4 2xl:px-64"
    >
      <ul className="grid grid-cols-5 gap-4 items-start justify-between pt-12">
        ...
        <li className="mb-8 md:mb-0">
          <div className="flex flex-col gap-2">
            ...
            <div className="">849 north canso New York City, United State.</div>
